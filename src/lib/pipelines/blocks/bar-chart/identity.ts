...
export const barChartIdentity: IdentitySpec = {
	kind: 'graphic',
	claim:
		'an editorial bar/column comparison with horizontal marks whose geometry remains faithful to its validated inline data',
	dimensions: [
		{
			name: 'mark-treatment',
			viaPack: 'chart.mark',
		...
		},
		{
			...
			definition:
				'Fail-closed factual contract for the bar/column comparison with horizontal marks.',
			probe: {
				kind: 'script',
