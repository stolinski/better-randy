...
export const columnChartIdentity: IdentitySpec = {
	...
	dimensions: [
		...
		},
		{
			...
			implementation:
				'src/lib/pipelines/blocks/column-chart/index.ts columnChartBlockRenderer wires the shared src/lib/pipelines/blocks/bar-chart/CanvasSource.svelte + src/lib/pipelines/shader-passes/chart-mark-renderer.ts — chart chrome is flat DOM ink and data marks are analytic masks; enclosing Surface/stage treatments own any edge, depth, or light.',
			definition:
