/**
 * Unit tests for cascade-welded sound-cue derivation (ADR-0035 §4 + ADR-0033).
 * Self-running node script:
 *
 *   node --experimental-strip-types src/lib/platform/sound-cues.test.ts
 */
...
console.log('sound-cues.test.ts: all assertions passed');
