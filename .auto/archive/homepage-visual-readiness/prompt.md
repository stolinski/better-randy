...
- `src/routes/api/user-compositions/+server.ts` — user-composition card/full listing and writes.
- `src/routes/api/posters/[key]/+server.ts` — dynamic poster response delivery.
