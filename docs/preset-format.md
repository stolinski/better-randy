...
```jsonc
{
	...
	"transition": { "from": "preset-slug", "to": "preset-slug", "effect": "mask-wipe", "durationMs": 600 } // optional
}
```
...
Focal (transforms surroundings): `magnify`, `lift-out`, `tear-out`, `isolate`.
