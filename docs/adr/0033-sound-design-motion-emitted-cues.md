...
Status: **Built** (all of §2–§9 shipped 2026-07-01, epic `1frpmv40` complete; first designed kit `syntax` by-ear approved — quick recorded fwips on the newspaper reference deliverables, core-synthesized fallback for unsourced events)
Date: 2026-06-26
