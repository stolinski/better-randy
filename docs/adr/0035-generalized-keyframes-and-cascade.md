...
> **Status: Designed, not built** — grilled 2026-07-01; tracked in dex epic `4i8gx2i7`. Supersedes the single-window tween as the general animation form; the existing `enter`/`exit` shape survives as load-time sugar.
