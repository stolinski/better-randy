...
Deno.test("verification fan-out starts every selected lane before awaiting completion", async () => {
...
Deno.test("verification fan-out records lane failures without discarding other results", async () => {
