...
| Pi Subagents `references/execution-controls.md`                        | Installed Pi runtime documentation               | `runs.all`, `worktree: true`, clean-check, durable handoff manifests, cleanup behavior          |
